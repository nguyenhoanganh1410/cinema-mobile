...
const HomeStackNavigator = () => {
  return (
    <Stack.Navigator screenOptions={screenOptionStyle}>
      ...
      <Stack.Screen  options={{ headerShown: false}} name="PickFilm" component={PickFilmScreen} />
    </Stack.Navigator>
  );
}
...
const ShowStackNavigator = () => {
    return (
      <Stack.Navigator screenOptions={screenOptionStyle}>
        ...
        <Stack.Screen  options={{ headerShown: false}} name="Showtimes" component={ShowTimePage} />
...
const PromotionStackNavigator = () => {
    return (
      <Stack.Navigator screenOptions={screenOptionStyle}>
        ...
        <Stack.Screen  options={{ headerShown: false}} name="Promotion" component={Promotion} />
      </Stack.Navigator>
    );
  }
...
export { LoginStackNavigator,ProfileStackNavigator, PromotionStackNavigator, ShowStackNavigator, HomeStackNavigator };
